...
type YangoClientTripsPageProps = {
...
export default async function YangoClientTripsPage({ searchParams }: YangoClientTripsPageProps) {
  ...
  return (
    <section className="crm-page relative">
      ...
      <PageHeading
        title={clientName}
        subtitle={`Yango trips from ${formatDateLabel(fromDate)} to ${formatDateLabel(toDate)}`}
      />
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-border/70 bg-white/60 px-4 py-3">
          <div>
            ...
            <p className="text-xs text-muted">
              Showing the same Yango/Supabase source as the dashboard for the selected period.
            </p>
          </div>
