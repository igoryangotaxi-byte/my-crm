/**
 * Pushes YANGO_TOKEN_OPTICITY from .env.local into Vercel (production, preview, development).
 * Run: npm run vercel:sync-yango-opticity-env
 * Auth: VERCEL_TOKEN or VERCEL_OIDC_TOKEN in .env.local (CLI / `vercel link` — тот же, что для других sync).
 * Requires: linked project (.vercel/project.json), vercel devDependency.
 */
...
const KEY = "YANGO_TOKEN_OPTICITY";
