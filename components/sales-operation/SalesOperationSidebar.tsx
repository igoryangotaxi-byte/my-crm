  ...
  const nav: NavNode[] = useMemo(
    () => [
      ...
      { kind: "leaf", href: "/sales-operation/pipeline", labelKey: "pipeline", page: "salesPipeline", icon: Columns3 },
      {
        kind: "group",
        id: "driversLeads",
        labelKey: "driversLeads",
        icon: Car,
        children: [
          {
            href: "/sales-operation/drivers-leads/pipeline",
            labelKey: "driversPipeline",
            page: "salesDriversPipeline",
            icon: Columns3,
          },
          {
            href: "/sales-operation/drivers-leads/dashboard",
            labelKey: "driversDashboard",
            page: "salesDriversPipeline",
            icon: BarChart3,
          },
          {
            href: "/sales-operation/drivers-leads/license",
            labelKey: "driversLicense",
            page: "salesDriversPipeline",
            icon: ShieldCheck,
          },
        ],
